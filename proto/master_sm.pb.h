...
class MasterOperator : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:paxos.MasterOperator) */ {
 public:
  MasterOperator();
  ...
  inline MasterOperator* New() const PROTOBUF_FINAL { return New(NULL); }

  MasterOperator* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  ...
  // @@protoc_insertion_point(class_scope:paxos.MasterOperator)
 private:
  void set_has_nodeid();
  ...
  void set_has_sid();
  void clear_has_sid();
  void set_has_lastversion();
  void clear_has_lastversion();
  ...
  friend struct protobuf_master_5fsm_2eproto::TableStruct;
};
// ===================================================================
