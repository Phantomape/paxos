...
const int InternalOptions::GetLearnerSenderPrepareTimeoutMs()
{
    if (is_large_buffer_mode_)
    {
        return 6000;
...
const int InternalOptions::GetLearnerSender_Ack_TimeoutMs()
{
    if (is_large_buffer_mode_)
    {
        return 60000;
...
const int InternalOptions::GetLearnerSender_Ack_Lead()
{
    if (is_large_buffer_mode_)
    {
        return 5;
...
const int InternalOptions::GetLearnerSenderSendQps()
{
    if (is_large_buffer_mode_)
    {
